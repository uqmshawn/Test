...
def test_init_mqtt_client():
    ...
    mock_client.is_connected.return_value = True  # Make is_connected return True
    ...
    with patch(
        ...
        with patch(
            "background_task.uuid.uuid4",
            return_value="12345678-1234-5678-1234-567812345678",
        ):
            # Patch connect_mqtt_client to return True
            with patch(
                "background_task.connect_mqtt_client", return_value=True
            ) as mock_connect:
                ...
                # Verify connect_mqtt_client was called with the right parameters
                mock_connect.assert_called_once_with(
                    ...
                    5,
                    keepalive=60,
                    # stability_delay is not explicitly passed, so it will use the default value
                )
